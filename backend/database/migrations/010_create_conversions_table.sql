-- Create conversions table for tracking affiliate sales
...
CREATE INDEX IF NOT EXISTS idx_conversions_transaction_id ON conversions(network, transaction_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_conversions_unique 
ON conversions(network, transaction_id);
